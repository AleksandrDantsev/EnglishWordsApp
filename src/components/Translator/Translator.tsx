                ...
                <div className={st.translator_form}>
                    <form>
                        <input  onChange={(e: React.ChangeEvent<HTMLInputElement>) => setWordSearch(e.target.value)}
                                ...
                                placeholder="Word" 
                                type="text" />
                        <button onClick={searchBtWord} className={st.translator_word_search} type="button">Search</button>
                    </form>
                </div>
                {resultQuery &&
